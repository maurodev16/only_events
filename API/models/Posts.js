...
const postSchema = new mongoose.Schema({
    establishmentId: { type: mongoose.Schema.Types.ObjectId, ref: "Establishment" },//Referência ao estabelecimento ao qual o post pertence.
    ...
    comments: [{
        userId: { type: mongoose.Schema.Types.ObjectId, ref: "User" }, // Referência ao modelo de usuário, se aplicável
